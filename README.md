...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-paws.end.user.computing-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14237&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-paws.end.user.computing-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-paws.end.user.computing` can be installed with:

```
conda install r-paws.end.user.computing
```

It is possible to list all of the versions of `r-paws.end.user.computing` available on your platform with:
